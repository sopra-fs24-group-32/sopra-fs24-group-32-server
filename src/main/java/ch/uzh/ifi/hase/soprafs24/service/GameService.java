...
public class GameService {
   ...
   public String generatePictureDallE(String prompt, User user, Long gameId) throws Exception {

    Optional<Game> lobbyOptional = gameRepository.findById(gameId);
    if (!lobbyOptional.isPresent()) {
       throw new ResponseStatusException(HttpStatus.NOT_FOUND, "Game not found");
    }

    Game lobby = lobbyOptional.get();
    lobby.setCurrentPictureGenerator(user.getUsername());
    ...
    lobby.setImageDescription(mappedPrompt);
    lobby.setCurrentPictureGenerator(user.getUsername());
    ...
    public void evaluatePlayerGuessWithChatGPT(String userToken, String playerGuessed, Game lobby) throws Exception{

        String originalText = lobby.getImageDescription();
    ...
    public String getLastImageDescription(Game lobby) {
        return lobby.getImageDescription();
    }
